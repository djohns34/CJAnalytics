 ...
 *
 */
public class CJDBCsvInputStream extends DBCsvInputStream{
  ...
  public CJDBCsvInputStream (Cursor dbCursor) {
    //this.mDB = dB;
  ...
  /* (non-Javadoc)
   * @see edu.calpoly.codastjegga.bulk.DBCsvInputStream#getRowsIds()
   */
  @Override
